...
<template>
  <div class="animate-slide-up">
    <!-- 欢迎横幅：总是显示在顶部 -->
    <WelcomeBanner class="mb-8 sm:mb-10 lg:mb-12" />
    
    <div class="flex flex-col lg:flex-row lg:gap-8 xl:gap-10">
      <div class="flex-1 min-w-0">
        ...
        <!-- 有筛选时的标题区 -->
        <div v-if="searchQuery || selectedTag || tagFromQuery" class="text-center py-6 sm:py-8 mb-6 sm:mb-8">
        ...
        <!-- 最新文章标题：无筛选时显示 -->
        <div v-if="!searchQuery && !selectedTag && !tagFromQuery" class="mb-6 sm:mb-8">
          <div class="flex items-center gap-3">
            <span class="flex w-9 h-9 sm:w-10 sm:h-10 items-center justify-center rounded-xl bg-gradient-to-br from-blog-primary/20 to-blog-secondary/20 text-blog-primary">
              <el-icon class="w-4 h-4 sm:w-5 sm:h-5"><Document /></el-icon>
            </span>
            <h2 class="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-100">最新文章</h2>
          </div>
        </div>
